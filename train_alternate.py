...
def parse_args_vgg():
    ...
    parser.add_argument('--rpn_epoch', help='end epoch of rpn training', default=1, type=int)
    ...
    parser.add_argument('--rcnn_epoch', help='end epoch of rcnn training', default=1, type=int)
