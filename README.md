...
* Start training by running `python train_end2end.py`. This will train the VGG network on VOC07 trainval.#0000000000000000000000
* Start testing by running `python test.py`. This will test the VGG network on the VOC07 test.#0000000000000000000000
